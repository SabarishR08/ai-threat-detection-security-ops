...
# Import all services
from backend.services.dashboard_enhancements import DashboardDataGenerator, ReportGenerator, ThemeManager
from backend.services.browser_extension import (TabSandbox, RealTimeURLScanner, AutoProtection,
                                        BrowserNotification, PermissionManager, ContextMenuManager)
from backend.services.intelligence_sources import ThreatIntelligenceAggregator
from backend.services.soc_analyzer_advanced import MITREAttackMapper, LogMonitor, ThreatCorrelation, IncidentResponse
from backend.services.webhook_manager import WebhookManager, EventPublisher, AlertForwarder, SlackIntegration
from backend.services.advanced_reporting import (ThreatReportGenerator, ThreatSignatureGenerator, 

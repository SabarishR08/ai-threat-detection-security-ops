...
def app():
    ...
    try:
        ...
        # Some versions of flask-limiter may not support this attribute
        logging.debug(f"Could not disable limiter: {e}")
...
def block_network(monkeypatch):
    ...
    try:
        ...
        # httpx may not be installed in all test environments
        logging.debug(f"Could not block httpx: {e}")
    ...
    try:
        ...
        # whois module may not be installed
        logging.debug(f"Could not mock whois: {e}")
